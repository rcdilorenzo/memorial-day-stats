...
var _simonh1000$elm_charts$ChartModel$initItem = F2(
	function (v, l) {
		return {value: v, normValue: 0, label: l};
	});
var _simonh1000$elm_charts$ChartModel$initItems = _elm_lang$core$List$map2(_simonh1000$elm_charts$ChartModel$initItem);
var _simonh1000$elm_charts$ChartModel$chartInit = F3(
	function (vs, ls, typ) {
		return {
			chartType: typ,
			items: A2(_simonh1000$elm_charts$ChartModel$initItems, vs, ls),
			title: '',
			colours: _elm_lang$core$Native_List.fromArray(
				['#BF69B1', '#96A65B', '#D9A679', '#593F27', '#A63D33']),
			styles: _elm_lang$core$Dict$fromList(
				_elm_lang$core$Native_List.fromArray(
					[
						{
						ctor: '_Tuple2',
...
var _simonh1000$elm_charts$ChartModel$Item = F3(
	function (a, b, c) {
		return {value: a, normValue: b, label: c};
	});
var _simonh1000$elm_charts$ChartModel$Model = F5(
	function (a, b, c, d, e) {
		return {chartType: a, items: b, title: c, colours: d, styles: e};
	});
var _simonh1000$elm_charts$ChartModel$Line = {ctor: 'Line'};
var _simonh1000$elm_charts$ChartModel$Pie = {ctor: 'Pie'};
var _simonh1000$elm_charts$ChartModel$BarVertical = {ctor: 'BarVertical'};
var _simonh1000$elm_charts$ChartModel$BarHorizontal = {ctor: 'BarHorizontal'};
		...
		A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$List$map,
					function (i) {
						return i * tickIncrement;
					},
					_elm_lang$core$Native_List.range(0, noTicks)))));
	var xaxis = A2(
		_elm_lang$core$List_ops['::'],
		A2(
			_evancz$elm_graphics$Collage$traced,
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												{ctor: '_Tuple2', _0: 'background-color', _1: col},
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$svg$Svg_Attributes$stroke(col),
						_elm_lang$svg$Svg_Attributes$strokeDashoffset(
						_elm_lang$core$Basics$toString(off)),
						_elm_lang$svg$Svg_Attributes$strokeDasharray(
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(ang),
							' 100')),
						_elm_lang$html$Html_Attributes$style(
						get$('chart-elements'))
					]),
		...
		function (val, _p2) {
			...
			if (_p4.ctor === '::') {
				...
				return {
					...
					_2: A2(
						_elm_lang$core$List_ops['::'],
						A3(elem, _p7, val.normValue, _p4._0),
						_p6)
				};
			} else {
		...
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$svg$Svg_Attributes$preserveAspectRatio('xMidYMid slice')
				]),
			elems),
			A2(
			_elm_lang$html$Html$div,
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(_p14.label)
							]))
					]));
		},
		model.items);
		...
		if (_p22.ctor === '[]') {
			...
			if (_p23.ctor === 'Pie') {
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						colours: A2(_elm_lang$core$List_ops['::'], _p24, _p22._1)
					});
			} else {
				return A3(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'background-color', _1: _p24}
						]),
					model);
			}
		}
...
var _simonh1000$elm_charts$Chart$lChart = F2(
	function (ds, ls) {
		return A3(
			_simonh1000$elm_charts$Chart$updateStyles,
			'chart-container',
			...
			A3(_simonh1000$elm_charts$ChartModel$chartInit, ds, ls, _simonh1000$elm_charts$ChartModel$Line));
	});
var _simonh1000$elm_charts$Chart$pie = F2(
	function (ds, ls) {
		return A3(
			_simonh1000$elm_charts$Chart$updateStyles,
			'legend-labels',
			...
			A3(
				...
				A3(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'fill-opacity', _1: '0'},
					...
					A3(
						...
						A3(
							...
							_simonh1000$elm_charts$Chart$toPercent(
								A3(_simonh1000$elm_charts$ChartModel$chartInit, ds, ls, _simonh1000$elm_charts$ChartModel$Pie)))))));
	});
var _simonh1000$elm_charts$Chart$vBar = F2(
	function (ds, ls) {
		return A3(
			_simonh1000$elm_charts$Chart$updateStyles,
			'legend-labels',
			...
			A3(
				...
				A3(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'background-color', _1: 'steelblue'},
					...
					A3(
						...
						A3(
							...
							_simonh1000$elm_charts$Chart$normalise(
								A3(_simonh1000$elm_charts$ChartModel$chartInit, ds, ls, _simonh1000$elm_charts$ChartModel$BarVertical)))))));
	});
var _simonh1000$elm_charts$Chart$hBar = F2(
	function (ds, ls) {
		return A3(
			_simonh1000$elm_charts$Chart$updateStyles,
			'legend-labels',
			...
			A3(
				...
				A3(
					...
					_simonh1000$elm_charts$Chart$addValueToLabel(
						_simonh1000$elm_charts$Chart$normalise(
							A3(_simonh1000$elm_charts$ChartModel$chartInit, ds, ls, _simonh1000$elm_charts$ChartModel$BarHorizontal))))));
	});

var _user$project$Model$rowToCSV = function (row) {
	var timestamp = A2(
		_mgold$elm_date_format$Date_Format$format,
		'%m/%d/%Y %I:%M:%S %p',
		_elm_lang$core$Date$fromTime(row.timestamp));
	var attrs = _elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$core$Basics$toString(row.passengers),
			row.attendedPreviously ? 'Yes' : 'No',
			row.source,
			timestamp
		]);
	return A2(_elm_lang$core$String$join, ',', attrs);
};
var _user$project$Model$toCSV = function (model) {
	var headers = 'Passengers,Attended Previously,Source,Timestamp';
	return A2(
		_elm_lang$core$String$join,
		'%0D%0A',
		A2(
			_elm_lang$core$List_ops['::'],
			headers,
			A2(_elm_lang$core$List$map, _user$project$Model$rowToCSV, model.rows)));
};
var _user$project$Model$passengerCountFilterMap = function (row) {
	return row.attendedPreviously ? _elm_lang$core$Maybe$Just(row.passengers) : _elm_lang$core$Maybe$Nothing;
};
var _user$project$Model$attendedPreviouslyCount = function (model) {
	var total = _elm_lang$core$List$sum(
		A2(
			...
			model.rows));
	var attendedPreviously = _elm_lang$core$List$sum(
		A2(_elm_lang$core$List$filterMap, _user$project$Model$passengerCountFilterMap, model.rows));
	return {ctor: '_Tuple2', _0: attendedPreviously, _1: total};
};
var _user$project$Model$attendedPreviouslyStatistic = function (model) {
	var _p0 = _user$project$Model$attendedPreviouslyCount(model);
	var attendedPreviously = _p0._0;
	var totalRows = _p0._1;
	var percentage = _elm_lang$core$Basics$round(
		(_elm_lang$core$Basics$toFloat(attendedPreviously) * 100) / _elm_lang$core$Basics$toFloat(totalRows));
	return A2(
		_elm_lang$core$Basics_ops['++'],
		...
		A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(attendedPreviously),
				' people)')));
};
var _user$project$Model$attendanceData = function (model) {
	var hoursToDescription = function (hours) {
		return A2(
			_mgold$elm_date_format$Date_Format$format,
			'%I %p',
			_elm_lang$core$Date$fromTime(_elm_lang$core$Time$hour * hours));
	};
	var hourOfRow = function (row) {
		return _elm_lang$core$Basics$toFloat(
			_elm_lang$core$Basics$floor(
				_elm_lang$core$Time$inHours(row.timestamp)));
	};
	var _p1 = _elm_lang$core$List$unzip(
		_elm_lang$core$Dict$toList(
			A2(_elm_community$dict_extra$Dict_Extra$groupBy, hourOfRow, model.rows)));
	var hours = _p1._0;
	var listOfRows = _p1._1;
	var values = A2(
		_elm_lang$core$List$map,
		function (row) {
			return _elm_lang$core$Basics$toFloat(
		...
		listOfRows);
	var labels = A2(_elm_lang$core$List$map, hoursToDescription, hours);
	return {ctor: '_Tuple2', _0: labels, _1: values};
};
var _user$project$Model$sourceData = function (model) {
...
var _user$project$Model$peopleCount = function (model) {
...
var _user$project$Model$vehicleCount = function (model) {
	return _elm_lang$core$Array$length(
		_elm_lang$core$Array$fromList(model.rows));
};
var _user$project$Model$Model = F4(
	function (a, b, c, d) {
		return {route: a, currentRow: b, toSave: c, rows: d};
	});
var _user$project$Model$Row = F4(
	function (a, b, c, d) {
		return {passengers: a, source: b, attendedPreviously: c, timestamp: d};
	});
var _user$project$Model$defaultRow = A4(_user$project$Model$Row, 0, '', false, 0);

var _user$project$Actions$Load = function (a) {
	return {ctor: 'Load', _0: a};
};
var _user$project$Actions$Confirmed = function (a) {
	return {ctor: 'Confirmed', _0: a};
};
var _user$project$Actions$ShowConfirm = function (a) {
	return {ctor: 'ShowConfirm', _0: a};
};
var _user$project$Actions$UpdateRow = function (a) {
	return {ctor: 'UpdateRow', _0: a};
};
var _user$project$Actions$TimeFetched = function (a) {
	return {ctor: 'TimeFetched', _0: a};
};
var _user$project$Actions$Identity = {ctor: 'Identity'};
var _user$project$Actions$ResetData = {ctor: 'ResetData'};
var _user$project$Actions$RouteToSettings = {ctor: 'RouteToSettings'};
var _user$project$Actions$RouteToStats = {ctor: 'RouteToStats'};
var _user$project$Actions$RouteToHome = {ctor: 'RouteToHome'};
var _user$project$Actions$Increment = {ctor: 'Increment'};
var _user$project$Actions$SaveRow = {ctor: 'SaveRow'};
var _user$project$Actions$UpdateSource = function (a) {
	return {ctor: 'UpdateSource', _0: a};
};
var _user$project$Actions$UpdatePassengers = function (a) {
	return {ctor: 'UpdatePassengers', _0: a};
};
var _user$project$Actions$UpdateAttendedPreviously = function (a) {
	return {ctor: 'UpdateAttendedPreviously', _0: a};
};

var _user$project$Views_Home$carsLabel = function (count) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(count),
		' Cars');
};
var _user$project$Views_Home$footerView = F2(
	function (left, right) {
		return A2(
...
var _user$project$Views_Home$content = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('btn-container add-btn-container')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('btn-span add-btn-span')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('add-btn blue'),
										_elm_lang$html$Html_Events$onClick(_user$project$Actions$Increment)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('+')
				...
				A2(
				_user$project$Views_Home$footerView,
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(
...
var _user$project$Views_HaveAttended$updateAction = function (bool) {
	return _user$project$Actions$UpdateRow(
		_user$project$Actions$UpdateAttendedPreviously(bool));
};
var _user$project$Views_HaveAttended$content = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('btn-container attended-btn-container')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('btn-span attended-btn-span')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('attended-btn attended-btn-yes green'),
								_elm_lang$html$Html_Events$onClick(
								_user$project$Views_HaveAttended$updateAction(true))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('attended-btn attended-btn-no red'),
								_elm_lang$html$Html_Events$onClick(
								_user$project$Views_HaveAttended$updateAction(false))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
...
var _user$project$Views_PassengerCount$number = function ($int) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('btn-grid-item passenger-btn-grid-item yellow'),
				_elm_lang$html$Html_Events$onClick(
				_user$project$Actions$UpdateRow(
					_user$project$Actions$UpdatePassengers($int)))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(
...
var _user$project$Views_PassengerCount$content = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('btn-container passenger-btn-container')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('btn-grid passenger-btn-grid')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Views_PassengerCount$number(1),
						_user$project$Views_PassengerCount$number(2),
						_user$project$Views_PassengerCount$number(3),
						_user$project$Views_PassengerCount$number(4),
						_user$project$Views_PassengerCount$number(5),
						_user$project$Views_PassengerCount$number(6),
						_user$project$Views_PassengerCount$number(7),
						_user$project$Views_PassengerCount$number(8),
						_user$project$Views_PassengerCount$number(9)
					]))
			]));
};

var _user$project$Views_Source$updateAction = function (source) {
	return _user$project$Actions$UpdateRow(
		_user$project$Actions$UpdateSource(source));
};
var _user$project$Views_Source$source = function (source) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(
						_user$project$Views_Source$updateAction(source))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$Views_Source$content = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Views_Source$source('Unknown'),
						_user$project$Views_Source$source('Banners'),
						_user$project$Views_Source$source('Flyers'),
						_user$project$Views_Source$source('Website'),
						_user$project$Views_Source$source('Social Media'),
						_user$project$Views_Source$source('Word of Mouth'),
						_user$project$Views_Source$source('Backlink')
					]))
			]));
};

var _user$project$Views_Stats$content = function (model) {
	var _p0 = _user$project$Model$attendanceData(model);
	var attendanceLabels = _p0._0;
	var attendanceValues = _p0._1;
	var _p1 = _user$project$Model$sourceData(model);
	var labels = _p1._0;
	var values = _p1._1;
	return A2(
		_elm_lang$html$Html$div,
...
var _user$project$Views_Settings$content = function (model) {
	var $export = A2(
		_elm_lang$core$Basics_ops['++'],
		'mailto:rcddeveloper@icloud.com?subject=Stats Export&body=',
		_user$project$Model$toCSV(model));
	var confirmAction = _user$project$Actions$ShowConfirm('Are you sure you want to reset ALL of the data?');
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('btn-container settings-btn-container')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('btn-span settings-btn-span')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('settings-btn settings-btn-reset red'),
								_elm_lang$html$Html_Events$onClick(confirmAction)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
...
var _user$project$View$notFound = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[]),
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Route Not Found')
				])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Events$onClick(_user$project$Actions$RouteToHome)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
...
var _user$project$View$navigationView = function (title) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('navigation-container white')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('navigation-item navigation-home')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('fa fa-home')
									]),
								_elm_lang$core$Native_List.fromArray(
									[]))
							]))
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('navigation-item navigation-title')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('navigation-item navigation-settings')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$Actions$RouteToSettings)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('fa fa-cogs')
									]),
								_elm_lang$core$Native_List.fromArray(
									[]))
							]))
...
var _user$project$View$layout = F3(
	function (title, model, content) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$View$navigationView(title),
					content
				]));
	});
var _user$project$View$renderView = function (model) {
	var _p0 = model.route;
	switch (_p0) {
		case '':
			return {
				ctor: '_Tuple2',
				_0: 'Home',
				_1: _user$project$Views_Home$content(model)
			};
		case '#/have_attended':
			return {
				ctor: '_Tuple2',
				_0: 'Previously Attended?',
				_1: _user$project$Views_HaveAttended$content(model)
			};
		case '#/passenger_count':
			return {
				ctor: '_Tuple2',
				_0: 'How Many Passengers?',
				_1: _user$project$Views_PassengerCount$content(model)
			};
		case '#/source':
			return {
				ctor: '_Tuple2',
				_0: 'Source?',
				_1: _user$project$Views_Source$content(model)
			};
		case '#/stats':
			return {
				ctor: '_Tuple2',
				_0: 'Stats',
				_1: _user$project$Views_Stats$content(model)
			};
		case '#/settings':
			return {
				ctor: '_Tuple2',
				_0: 'Settings',
				_1: _user$project$Views_Settings$content(model)
			};
		default:
			return {ctor: '_Tuple2', _0: 'Memorial Day', _1: _user$project$View$notFound};
	}
};
var _user$project$View$render = function (model) {
	var _p1 = _user$project$View$renderView(model);
	var title = _p1._0;
	var content = _p1._1;
	return A3(_user$project$View$layout, title, model, content);
};

var _user$project$Main$saveCurrentRow = function (model) {
	var _p0 = model.currentRow;
	if (_p0.ctor === 'Nothing') {
		return model;
	} else {
		return _elm_lang$core$Native_Utils.update(
...
var _user$project$Main$fetchTime = A3(
	_elm_lang$core$Task$perform,
	function (_p1) {
		return _user$project$Actions$Identity;
	},
	_user$project$Actions$TimeFetched,
	_elm_lang$core$Time$now);
var _user$project$Main$addCurrentToSaveList = function (model) {
...
var _user$project$Main$updateRow = F2(
	function (model, rowFunction) {
		var row = rowFunction(
			A2(_elm_lang$core$Maybe$withDefault, _user$project$Model$defaultRow, model.currentRow));
		return _elm_lang$core$Native_Utils.update(
			model,
			{
...
var _user$project$Main$save = _elm_lang$core$Native_Platform.outgoingPort(
	...
	function (v) {
		return {
			route: v.route,
			currentRow: (v.currentRow.ctor === 'Nothing') ? null : {passengers: v.currentRow._0.passengers, source: v.currentRow._0.source, attendedPreviously: v.currentRow._0.attendedPreviously, timestamp: v.currentRow._0.timestamp},
			toSave: _elm_lang$core$Native_List.toArray(v.toSave).map(
				function (v) {
					return {passengers: v.passengers, source: v.source, attendedPreviously: v.attendedPreviously, timestamp: v.timestamp};
				}),
			rows: _elm_lang$core$Native_List.toArray(v.rows).map(
				function (v) {
					return {passengers: v.passengers, source: v.source, attendedPreviously: v.attendedPreviously, timestamp: v.timestamp};
				})
		};
	});
var _user$project$Main$persist2 = function (_p3) {
	var _p4 = _p3;
	var _p5 = _p4._0;
	return {
		ctor: '_Tuple2',
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			_elm_lang$core$Native_List.fromArray(
				[
					_p4._1,
					_user$project$Main$save(_p5)
				]))
	};
};
var _user$project$Main$persist2WithCmd = F2(
	function (task, _p6) {
		var _p7 = _p6;
		return _user$project$Main$persist2(
			{
				ctor: '_Tuple2',
				_0: _p7._0,
				_1: _elm_lang$core$Platform_Cmd$batch(
...
var _user$project$Main$persist = function (model) {
	return {
		ctor: '_Tuple2',
		_0: model,
		_1: _user$project$Main$save(model)
	};
};
var _user$project$Main$location = _elm_lang$core$Native_Platform.outgoingPort(
	'location',
	function (v) {
		return v;
	});
var _user$project$Main$changeRoute = F2(
	function (newRoute, model) {
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{route: newRoute}),
			_1: _user$project$Main$location(newRoute)
		};
	});
var _user$project$Main$handleConfirmResetData = F2(
	function (model, confirmed) {
		return confirmed ? _user$project$Main$persist2(_user$project$Main$init) : _user$project$Main$persist2(
			A2(_user$project$Main$changeRoute, '', model));
	});
var _user$project$Main$confirm = _elm_lang$core$Native_Platform.outgoingPort(
	'confirm',
	function (v) {
		return v;
	});
	...
	function (msg, model) {
		...
		switch (_p8.ctor) {
			...
			case 'Increment':
				return _user$project$Main$persist2(
					A2(
						_user$project$Main$changeRoute,
						'#/have_attended',
						_elm_lang$core$Native_Utils.update(
							model,
							{
								currentRow: _elm_lang$core$Maybe$Just(_user$project$Model$defaultRow)
							})));
			case 'RouteToHome':
				return _user$project$Main$persist2(
					A2(
			...
			case 'RouteToSettings':
				return _user$project$Main$persist2(
					A2(_user$project$Main$changeRoute, '#/settings', model));
			case 'RouteToStats':
				return _user$project$Main$persist2(
					A2(_user$project$Main$changeRoute, '#/stats', model));
			case 'ShowConfirm':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$confirm(_p8._0)
				};
			case 'Confirmed':
				return _elm_lang$core$Native_Utils.eq(model.route, '#/settings') ? A2(_user$project$Main$handleConfirmResetData, model, _p8._0) : {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'TimeFetched':
				...
				var updatedRows = A2(_elm_lang$core$List$map, update, model.toSave);
				var updatedModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						toSave: _elm_lang$core$Native_List.fromArray(
							[]),
						rows: A2(_elm_lang$core$Basics_ops['++'], model.rows, updatedRows)
					});
				return _user$project$Main$persist2(
					{ctor: '_Tuple2', _0: updatedModel, _1: _elm_lang$core$Platform_Cmd$none});
			case 'ResetData':
				return _user$project$Main$persist2(_user$project$Main$init);
			case 'Identity':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				switch (_p8._0.ctor) {
					case 'UpdateAttendedPreviously':
						var update = function (row) {
							return _elm_lang$core$Native_Utils.update(
								row,
								{attendedPreviously: _p8._0._0});
						};
						return _user$project$Main$persist2(
							A2(
								_user$project$Main$changeRoute,
								'#/passenger_count',
								A2(_user$project$Main$updateRow, model, update)));
					case 'UpdatePassengers':
						var update = function (row) {
							return _elm_lang$core$Native_Utils.update(
								row,
								{passengers: _p8._0._0});
						};
						return _user$project$Main$persist2(
							A2(
								_user$project$Main$changeRoute,
					...
					case 'UpdateSource':
						...
						return A2(
							_user$project$Main$persist2WithCmd,
							_user$project$Main$fetchTime,
							A2(
								_user$project$Main$changeRoute,
								'',
								_user$project$Main$addCurrentToSaveList(
									A2(_user$project$Main$updateRow, model, update))));
					default:
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
...
var _user$project$Main$storage = _elm_lang$core$Native_Platform.incomingPort(
	'storage',
	A2(
					...
					_elm_lang$core$Json_Decode$oneOf(
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(
									_elm_lang$core$Json_Decode$andThen,
									A2(_elm_lang$core$Json_Decode_ops[':='], 'passengers', _elm_lang$core$Json_Decode$int),
									function (passengers) {
										return A2(
											_elm_lang$core$Json_Decode$andThen,
											...
											function (source) {
												return A2(
													_elm_lang$core$Json_Decode$andThen,
													A2(_elm_lang$core$Json_Decode_ops[':='], 'attendedPreviously', _elm_lang$core$Json_Decode$bool),
													function (attendedPreviously) {
														return A2(
															_elm_lang$core$Json_Decode$andThen,
															A2(_elm_lang$core$Json_Decode_ops[':='], 'timestamp', _elm_lang$core$Json_Decode$float),
															function (timestamp) {
																return _elm_lang$core$Json_Decode$succeed(
																	{passengers: passengers, source: source, attendedPreviously: attendedPreviously, timestamp: timestamp});
															});
													});
											});
									}))
					...
					return A2(
						...
						function (toSave) {
							return A2(
								...
								function (rows) {
									return _elm_lang$core$Json_Decode$succeed(
										{route: route, currentRow: currentRow, toSave: toSave, rows: rows});
								});
						});
				});
		}));
var _user$project$Main$confirmed = _elm_lang$core$Native_Platform.incomingPort('confirmed', _elm_lang$core$Json_Decode$bool);
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Main$storage(_user$project$Actions$Load),
				_user$project$Main$confirmed(_user$project$Actions$Confirmed)
			]));
};
